...
var cid=$("#cid").val();
  ...
  type: "POST",
  url:"ajaxCalls/getpurchaseorderdetails1.php",
  dataType:'JSON',
...
$.ajax({
  data: {'bill_id':bill_id,"bill":"bill"} ,
  type: "POST",
  url:"ajaxCalls/getpurchaseorderdocuments.php",
  dataType:'JSON',
  success: function(dataResult) {
...
// alert(vale.length);
  ...
  if(bill_id=='')
  {
    ...
    var shipmentdate=$("#shipmentdate").val();
      ...
      $.ajax({
      type: "POST",
      url:"ajaxCalls/edit_purchaseorder.php",
      dataType:'JSON',
      data: $.param(obj)+'&'+$.param(doc_obj)+'&'+$.param(cobj)+'&purchaseorderno='+purchaseorderno+'&orderdate='+orderdate+'&shipmentdate='+shipmentdate,
      success: function(dataResult) {
