        ...
        <table>
                ...
                <th class="ts-pager">
                  <div class="form-inline">
                    ...
                    <input type="text" class="form-control" placeholder="Search...." id="mySearch" style="width: 170px; margin: 5px;" onkeyup="getpayables(this)" />
...
function getpayables()
{
  ...
  $(function() {
    ...
    .tablesorterPager({
        ...
        ajaxUrl: "ajaxCalls/getpayables.php?page={page}&size={size}&search="+search,
