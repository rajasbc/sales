        ...
        <table>
                ...
                <th class="ts-pager">
                  <div class="form-inline">
                    ...
                    <input type="text" class="form-control" placeholder="Search...." id="mySearch" style="width: 170px; margin: 5px;" onkeyup="getreceivables(this)" />
...
?>
  ...
  <script>
    ...
    //  $.ajax({
    //   type:"POST",
    //   url:'ajaxCalls/getreceivables.php',
    //   dataType:"json",
...
function getreceivables()
{
  ...
  $(function() {
    ...
    .tablesorterPager({
        ...
        ajaxUrl: "ajaxCalls/getreceivables.php?page={page}&size={size}&search="+search,
