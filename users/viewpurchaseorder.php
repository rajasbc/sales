        ...
        <div class="row align-items-center">
         <div class="col-md-12">
          <div class="page-header-title">
           <h5 class="m-b-10">Outgoing PO View</h5>
         </div>
         <ul class="breadcrumb">
           <li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
           <!-- <li class="breadcrumb-item">Outgoing</li> -->
           <li class="breadcrumb-item">Outgoing PO View</li>
         </ul>
       </div>
     </div>
   </div>
...
//alert(count);
    ...
    .tablesorterPager({
        ...
        ajaxUrl: "ajaxCalls/getpurchaseorders.php?page={page}&size={size}&search="+search+"&fdate="+ fdate +"&tdate="+ tdate,
