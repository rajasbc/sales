...
?>
 ...
 <script type="text/javascript">
   ...
   function postValue(){
            ...
            $.ajax({
                type:"POST",
                url:"ajaxCalls/addreceipt.php",
                dataType:"json",
                data:({"bill_id":bill_id,"cust_id":cust_id,"pay":balance_received,"invoice_no":invoice_no}),
                success:function(res)
                {
                    // console.log(res);
                    $.growl.notice({
...
//alert(count);
    ...
    .tablesorterPager({
        ...
        ajaxUrl: "ajaxCalls/getsales.php?page={page}&size={size}&search="+search+"&fdate="+ fdate +"&tdate="+ tdate,
