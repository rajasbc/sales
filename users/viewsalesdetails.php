        ...
        <div class="row align-items-center">
         <div class="col-md-12">
          <div class="page-header-title">
           <h5 class="m-b-10">Outgoing Invoice Details</h5>
         </div>
         <ul class="breadcrumb">
   ...
   <div class="col-xl-12">
    <div class="card">
     <div class="card-header">
      ...
      <h4>Invoice# <span style="color:#fd6a01;"><?=$ordresult['invoice_no']?></span></h4>
...
<div class="table-responsive">
        ...
        <tbody>
          ...
          foreach($doc_result as $value)
          {
            ...
            <td><button type="button" class="btn btn-default btn-sm" data-id="../upload/sales_documents/'.$value['document_name'].'" onclick="viewItem(this)"><span class="glyphicon glyphicon-trash"><i class="fas fa-eye" style="color:darkblue;"></i></span></button></td></tr>';
  ...
  <?php }?>
    ...
    <div class="row mt-2" style="float:right;"><a href="viewsales.php" class="btn btn-sm btn-primary" style="float:right;">Back</a></div>
...
type: "POST",
dataType: "json",
data: {'id':$("#delete_id").val(),'type':'sales'},
// cache: false,
