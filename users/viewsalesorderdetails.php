...
<div class="table-responsive">
        ...
        <tbody>
          ...
          foreach($doc_result as $value)
          {
            ...
            <td><button type="button" class="btn btn-default btn-sm" data-id="../upload/salesorder_documents/'.$value['document_name'].'" onclick="viewItem(this)"><span class="glyphicon glyphicon-trash"><i class="fas fa-eye" style="    color:darkblue;"></i></span></button></td></tr>';
      ...
      <div class="table-responsive">
        ...
        <tbody>
          ...
          foreach($result as $row)
          {
            ...
            echo"<tr><td>".$sno."</td><td>".$presult['name']."</td><td>".$row['rate']."</td><td>".$row['qty']."</td><td class='text-center'>".$row['tax']." %</td><td class='text-right pr-5'>".$row['total']."</td></tr>";
...
type: "POST",
dataType: "json",
data: {'id':$("#delete_id").val(),'type':'salesorder'},
// cache: false,
